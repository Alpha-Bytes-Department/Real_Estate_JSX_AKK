...
//                     <div className="relative w-full mt-4 grid gap-3">
...
//                             type="button"
//                             variant="ghost" 
//                             className="absolute right-1 top-8 h-8 w-8 cursor-pointer" 
...
//                             I agree to the 
//                             <Link href="" className="text-[#0F3DDE] ml-1">
//                                 terms & policy
//                             </Link>
//                         </Label>
//                     </div>
...
//                         <Button 
//                             type="button"
//                             className="flex gap-3 cursor-pointer bg-[#D9D9D9] hover:bg-[#D9D9D9]"
//                         >
//                             <Image src="/Google_Icon.svg" alt="google_icon" height={10} width={15} />
//                             <Label className="text-[#000000] font-poppins font-sm cursor-pointer">
//                                 Sign in with Google
//                             </Label>
//                         </Button>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-sm">
                    ...
                    <div className="relative w-full mt-4 grid gap-3">
                        ...
                        <Input
                            ...
                            {...register("password")}
                        />
                        <Button type="button" variant="ghost" className="absolute right-1 top-1/2 -translate-y-1/2 h-8 w-8 
                    ...
                    <div className="relative w-full mt-4 grid gap-3">
                        <Label htmlFor="confirmPassword" className="text-[#000000] font-poppins">Confirm
                            Password</Label>
                        <Input
                            type={showPassword2 ? "text" : "password"}
                            id="confirmPassword"
                    ...
                    <div className="flex items-start gap-3 mt-4">
                        <Checkbox id="terms-and-policy"
                            ...
                            onCheckedChange={(checked) => setValue("agreeToTerms", checked)}
                        />
                        <Label htmlFor="terms-and-policy" className="text-[#000000] font-poppins">I agree to
                            the<Link href="" className="text-[#0F3DDE]">
